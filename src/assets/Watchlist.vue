<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 747.62 526"
    xmlns:xlink="http://www.w3.org/1999/xlink">
    <g id="Group_33" data-name="Group 33" transform="translate(-227 -187)">
      <path id="Path_498-176" data-name="Path 498"
      ...
      <path id="Path_499-177" data-name="Path 499" d="M672.8,514.162H661.373l-5.437-44.1h16.873Z"
        transform="translate(227 187)" fill="#ffb8b8" />
      <path id="Path_500-178" data-name="Path 500"
        d="M653.207,510.894h22.048v13.882h-35.93a13.882,13.882,0,0,1,13.882-13.882Z" transform="translate(227 187)"
        fill="#2f2e41" />
      <path id="Path_501-179" data-name="Path 501" d="M646.855,484.9l-11.1,2.728-15.806-41.523,16.385-4.027Z"
        transform="translate(227 187)" fill="#ffb8b8" />
      <path id="Path_502-180" data-name="Path 502"
      ...
      <path id="Path_503-181" data-name="Path 503"
      ...
      <path id="Path_504-182" data-name="Path 504"
        ...
        transform="translate(0.81)" fill="#42b883" />
      <path id="Path_505-183" data-name="Path 505"
        ...
        transform="translate(0.81)" fill="#2f2e41" />
      <path id="Path_506-184" data-name="Path 506"
        ...
        transform="translate(0.81)" fill="#2f2e41" />
      <path id="Path_507-185" data-name="Path 507"
      ...
      <path id="Path_509-187" data-name="Path 509"
        ...
        transform="translate(0.81)" fill="#2f2e41" />
      <path id="Path_511-188" data-name="Path 511"
      ...
      <path id="Path_512-189" data-name="Path 512"
      ...
      <path id="Path_513-190" data-name="Path 513"
      ...
      <path id="Path_523-201" data-name="Path 523" d="M972.81,713h-198a1,1,0,0,1,0-2h198a1,1,0,0,1,0,2Z"
        transform="translate(0.81)" fill="#ccc" />
      <path id="Path_561-202" data-name="Path 561"
