...
<h1>Privacy Policy</h1>
  ...
  <ul>
    ...
    <li>
      <p>
        <strong>Website</strong> refers to Kanbaneon, accessible from
        <a
          href="https://kanbaneon.netlify.app/"
          rel="external nofollow noopener"
          target="_blank"
          >https://kanbaneon.netlify.app/</a
        >
      </p>
    </li>
    <li>
  ...
  <ul>
    <li>
      <p>By email: kanbaneon.adm@gmail.com</p>
    </li>
    <li>
      <p>By phone number: 98882256</p>
    </li>
  </ul>`
</script>
